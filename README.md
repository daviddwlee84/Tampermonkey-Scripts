...
| Script | 用途 | 生效網站 | Version | 安裝 |
| --- | --- | --- | --- | --- |
| [arXiv AI Assistant](userscripts/arxiv-ai-assistant/) | arXiv／papers.cool 論文資訊與引用探索、Google Scholar 跳轉，以及 Kimi／Gemini 繁中摘要 | `https://arxiv.org/abs/*`<br>`https://papers.cool/arxiv/*`<br>`https://gemini.google.com/app*`<br>`https://scholar.google.com/scholar*`<br>`https://scholar.google.com/citations*`<br>`https://scholar.google.com.tw/scholar*`<br>`https://scholar.google.com.tw/citations*`<br>`https://scholar.google.com.hk/scholar*`<br>`https://scholar.google.com.hk/citations*`<br>`https://scholar.google.co.uk/scholar*`<br>`https://scholar.google.co.uk/citations*` | 0.4.0 | [Install](https://raw.githubusercontent.com/daviddwlee84/Tampermonkey-Scripts/main/userscripts/arxiv-ai-assistant/arxiv-ai-assistant.user.js) |
