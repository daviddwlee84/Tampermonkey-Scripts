...
| --- | --- | --- | --- | --- |
| [ChatGPT Export Markdown](userscripts/chatgpt-export-markdown/) | 把整段 ChatGPT 對話匯成 Markdown（含 Agent Handoff 與原始 JSON），貼給 coding agent 用 | `https://chatgpt.com/*` | 1.3.0 | [Install](https://raw.githubusercontent.com/daviddwlee84/Tampermonkey-Scripts/main/userscripts/chatgpt-export-markdown/chatgpt-export-markdown.user.js) |
...
| [YouTube Gemini Summary](userscripts/youtube-gemini-summary/) | 在 YouTube 影片卡片與觀看頁一鍵開啟 Gemini，送出繁中摘要提示 | `https://www.youtube.com/*`<br>`https://gemini.google.com/app*` | 0.1.1 | [Install](https://raw.githubusercontent.com/daviddwlee84/Tampermonkey-Scripts/main/userscripts/youtube-gemini-summary/youtube-gemini-summary.user.js) |
